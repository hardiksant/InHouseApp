...
import { Filter, Search, Phone, MapPin, DollarSign, Calendar, CreditCard as Edit, Trash2 } from 'lucide-react';
...
export function AllLeads() {
  ...
  const applyFilters = () => {
    ...
    if (filters.product) {
      filtered = filtered.filter(lead => lead.product_interested === filters.product);
    }
    ...
    if (filters.leadSource) {
      filtered = filtered.filter(lead => lead.lead_source === filters.leadSource);
    }
